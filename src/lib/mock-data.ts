...
const snsNames = [
  'darkpool.sol', 'rugmaster.sol', 'alpha_trader.sol', 'moon_dev.sol',
  'degen_king.sol', 'pump_lord.sol', 'sol_whale.sol', 'token_sniper.sol',
  'rug_hunter.sol', 'meme_deployer.sol', 'fast_dev.sol', 'serial_dev.sol'
]
