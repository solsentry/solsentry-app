...
const MOCK_CRITICAL: MockTokenData = {
  ...
  signals: [
    {
      label: "Deployer is serial rugger",
      impact: -40,
      description: "2,953 confirmed rugs across 3,212 tokens",
    },
    {
      label: "Bundle launch detected",
      impact: -22,
      description: "Coordinated snipers + dev wallets in first 8 blocks",
    },
    {
      label: "Top 5 holders control 68%",
      impact: -18,
      description: "Extreme concentration — classic drain setup",
    },
    { label: "No locked liquidity", impact: -12, description: "LP not burned or locked" },
    {
      label: "Rapid holder decay pattern",
      impact: -8,
      description: "Matches 14 previous rugs by same dev",
    },
  ],
  holdersTable: [
    {
    ...
    {
      address: "3n4fJ3vKxL9pQ2mR7sT8uV6wX5yZ4aB3cD2eF1gH9iJ",
      balance: "11.9M",
      pct: 11.9,
      label: "Unknown",
    },
    {
      address: "5tYbN8mK2pL7vR3sX9wQ4uE6iO1aP5bC7dF9gH2jK4lM",
      balance: "9.2M",
      pct: 9.2,
      label: "Sniper cluster",
    },
    {
      address: "8vZcM3nP6qR9sT2uV5wX8yZ1aB4cD7eF0gH3iJ6kL9mN",
      balance: "4.8M",
      pct: 4.8,
      label: "Unknown",
    },
  ...
  similarTokens: [
    {
      mint: "7vKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU",
      symbol: "DUMP",
      risk: "CRITICAL",
      outcome: "Rug (3h)",
    },
    {
      mint: "2n4fJ3vKxL9pQ2mR7sT8uV6wX5yZ4aB3cD2eF1gH9iJ",
      symbol: "EXIT",
      risk: "CRITICAL",
      outcome: "Rug (11h)",
    },
    {
      mint: "9tYbN8mK2pL7vR3sX9wQ4uE6iO1aP5bC7dF9gH2jK4lM",
      symbol: "RUGV2",
      risk: "HIGH",
      outcome: "Rug (41h)",
    },
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        >
          {[
            ...
            },
            {
              ...
              value: `${data.topHolderConcentration}%`,
            ...
            >
              <div style={{ fontSize: 11, color: TOKENS.textDim, marginBottom: 4 }}>
                {stat.label}
              </div>
        ...
        {/* RISK BREAKDOWN */}
        <div style={{ marginBottom: 32 }}>
          <div style={{ fontSize: 13, color: TOKENS.textMuted, marginBottom: 10, fontWeight: 600 }}>
            RISK BREAKDOWN
          </div>
          <div
            style={{
            ...
            {data.signals.map((sig, idx) => (
              <div
                ...
                style={{
                  ...
                  padding: "10px 0",
                  borderBottom:
                    idx < data.signals.length - 1 ? `1px solid ${TOKENS.border}` : "none",
                }}
              >
                <div>
                ...
                <div
                  style={{
                    fontSize: 15,
                    fontWeight: 700,
                    color: sig.impact < 0 ? TOKENS.critical : TOKENS.safe,
                    minWidth: 52,
                    textAlign: "right",
                  }}
                >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 32 }}>
          ...
          >
            ...
            <div style={{ fontFamily: TOKENS.fontMono, fontSize: 13, marginBottom: 8 }}>
              {data.devWallet}
            </div>
            ...
            <Link
              href={`/operator/${data.devWallet}`}
              style={{ fontSize: 13, color: TOKENS.amber, marginTop: 12, display: "inline-block" }}
            >
          ...
          >
            <div style={{ fontSize: 13, color: TOKENS.textDim, marginBottom: 8 }}>
              TOP HOLDERS (CONCENTRATION WARNING)
            </div>
            {data.holdersTable.slice(0, 4).map((h, i) => (
              <div
                ...
                style={{
                  ...
                  fontSize: 13,
                  padding: "5px 0",
                  borderBottom: i < 3 ? `1px solid ${TOKENS.border}` : "none",
                }}
              >
                ...
                <div style={{ color: TOKENS.textMuted }}>
                  {h.pct}% <span style={{ color: TOKENS.textDim }}>({h.label})</span>
                </div>
              </div>
            ))}
            <div style={{ fontSize: 12, color: TOKENS.critical, marginTop: 8 }}>
              Top 5 control {data.topHolderConcentration}% — high rug risk
            </div>
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
            ...
            <span style={{ marginLeft: "auto", fontSize: 12, color: TOKENS.textDim }}>
              Confidence: {data.confidence}% • {data.lastUpdated}
            </span>
          </div>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{ fontSize: 13, color: TOKENS.textDim, marginBottom: 10 }}>
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 13, color: TOKENS.textMuted }}>
              Real-time operator risk for your users. Free public API + MCP.
            </div>
          </div>
