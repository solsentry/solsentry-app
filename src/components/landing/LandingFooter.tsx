...
/**
 * Ultra-lean footer for the public Easy homepage.
 * Keeps only the essential public links. No heavy upsell, no Pro/Dashboard links.
 * Full navigation + auth chrome lives in the top bar (LandingChrome).
 */
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6, fontSize: 13 }}>
              ...
              {/* Docs intentionally not here — it currently lives inside the Pro experience */}
            </div>
          </div>
        </div>

        {/* Bottom bar - user's preferred line */}
        <div
          style={{
            borderTop: "1px solid var(--border)",
            paddingTop: 20,
