    ...
    <div className="px-4 pb-4 bg-background border-t border-[#1F1B14]">
      ...
      <div className="relative overflow-x-auto">
        <div className="flex">
          {/* Y Axis */}
          <div
            className="w-14 shrink-0 flex flex-col justify-between pr-2 text-right"
          ...
          <div className="flex-1 relative" style={{ height: chartHeight }}>
            {/* Zero line at center */}
            <div className="absolute w-full border-t border-[#404040]" style={{ top: "50%" }} />
...
function WalletRow({
  ...
  return (
    <div className="border-b border-[#1F1B14]">
      ...
      {/* Expanded chart */}
      {isExpanded && <PnlChart wallet={wallet} onClose={onToggle} />}
    </div>
  );
}
...
export function SmartMoneyPanel() {
  ...
  const filteredWallets =
    activeFilter === "all" ? mockWallets : mockWallets.filter((w) => w.type === activeFilter);
